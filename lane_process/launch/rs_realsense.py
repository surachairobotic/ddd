...
configurable_parameters = [{'name': 'camera_name',                  'default': 'camera', 'description': 'camera unique name'},
                           ...
                           {'name': 'config_file',                  'default': "'/home/probook/ros2_ws/src/agribot/lane_process/config/d415.yaml'", 'description': 'yaml config file'},
                           ...
                           {'name': 'confidence_fps',               'default': '15.', 'description': ''},
                           {'name': 'infra_fps',                    'default': '15.', 'description': ''},
                           {'name': 'color_fps',                    'default': '15.', 'description': ''},
                           {'name': 'gyro_fps',                     'default': '15.', 'description': ''},
                           {'name': 'accel_fps',                    'default': '15.', 'description': ''},
